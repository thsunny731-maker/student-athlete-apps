...
본 이용약관(이하 '약관')은 **학생선수 스마트 출결 관리**(이하 '본 서비스')가 제공하는 교육 및 출결 관리 웹 애플리케이션 서비스의 이용에 관한 사항을 규정합니다.

### 제1조 (목적)
이 약관은 본 서비스가 제공하는 무료 교육용 웹 애플리케이션 서비스(이하 '서비스')를 이용함에 있어 서비스 제공자와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

### 제2조 (정의)
* **'서비스'**란 본 플랫폼에서 제공하는 학생선수 출결 관리 및 학교장확인서 신청 등을 위한 웹 애플리케이션을 말합니다.
* **'이용자'**란 본 서비스에 접속하여 이 약관에 따라 서비스를 이용하는 회원 및 비회원을 말합니다.
* **'회원'**이란 본 서비스에 구글 계정을 통해 회원등록을 한 자로서, 서비스를 이용할 수 있는 자(학부모 및 교사)를 말합니다.
...
### 제4조 (서비스의 제공)
* 본 서비스는 교육 활동 지원 및 출결 관리 목적의 무료 웹 애플리케이션을 제공합니다.
...
### 제6조 (회원가입)
① 이용자는 서비스가 정한 가입 양식에 따라 학생 정보를 기입하고 구글 소셜 로그인 연동을 마친 후 이 약관에 동의함으로써 회원가입을 신청합니다.
